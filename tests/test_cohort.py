...
def _dataset() -> pd.DataFrame:
    return pd.DataFrame(
        {
            "pat_ID": ["A1", "A1", "A1", "B1", "B1", "C1", "C1", "C1"],
            "Visit_months_from_diagnosis": [0, 12, 18, 0, 9, 0, 6, 12],
            "Age_diagnosis": [45, 45, 45, 60, 60, 52, 52, 52],
            "Sex": [1, 1, 1, 0, 0, 1, 1, 1],
            "RF_positivity": [1, 1, 1, 0, 0, 1, 1, 1],
            "anti_CCP": [1, 1, 1, 0, 0, 1, 1, 1],
            "DAS28": [5.2, 5.0, 5.1, 2.2, 2.0, 3.7, 3.8, 3.9],
            "Pat_global": [72, 74, 73, 30, 25, 62, 63, 64],
            "Ph_global": [70, 72, 71, 20, 18, 55, 56, 57],
            "CRP": [2.3, 2.1, 2.2, 0.4, 0.5, 1.3, 1.2, 1.4],
            "csDMARD1": [1, 1, 1, 2, 2, 1, 1, 1],
            "csDMARD2": [None, None, None, None, None, None, None, None],
            "csDMARD3": [None, None, None, None, None, None, None, None],
            "bDMARD": [1, 3, 3, None, None, 1, 2, 2],
